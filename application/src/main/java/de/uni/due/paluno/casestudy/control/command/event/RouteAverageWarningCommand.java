 ...
 * 
 */
public class RouteAverageWarningCommand extends RouteEventCommand {

	public RouteAverageWarningCommand(Route route) {
		super(route);
	}
	...
	protected void execute(EPRuntime epr, Map<String, Object> eventParams) {
		...
		raee.setKey(Globals.E_EVENT_ROUTE_AVERAGE_WARNING);
	...
	public String getEPL() {
		String epl = "select avg(data) as " + this.getColumns()[0] + " from "
				...
				+ Globals.WARNING_LEVEL + " and avg(data) < "
	...
	protected String getRouteInfoMessage(Map<String, Object> eventParams) {
		return "Average temperature critical";
	}
}
